...
{
    public class RaccoonStatue : LargeTerrainFeature
    {
        ...
        public RaccoonStatue()
            : base(needsTick: false)
        {
        }

        public RaccoonStatue(Vector2 tileLocation, string targetLocation, int targetX, int targetY)
            : base(needsTick: false)
        {
            Tile = tileLocation;
        ...
        public override void draw(SpriteBatch spriteBatch)
        {
            ...
            Vector2 t = Tile;
            Vector2 worldPos = new Vector2(t.X * 64f, (t.Y - 1) * 64f);
            spriteBatch.Draw(Sprite,
                Game1.GlobalToLocal(worldPos),
